...
def test_scoresheet_error():
    with pytest.raises(SystemExit) as e:
        run_test(
            "002_broken_scoresheet.csv", "001_data.csv", "001_expected.csv")
        assert e.value.code == 1


def test_excel_integration():
    run_excel_test(
        "003_scoresheet.xlsx", "003_data.xlsx", "003_expected.csv")


def test_excel_specific_sheet():
    run_excel_test(
        "003_scoresheet.xlsx", "003_data.xlsx", "004_expected.csv", 1)
